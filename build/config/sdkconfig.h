...
#define CONFIG_TINYUSB_DESC_BCD_DEVICE 0x200
#define CONFIG_TINYUSB_DESC_MANUFACTURER_STRING "Default"
#define CONFIG_TINYUSB_DESC_PRODUCT_STRING "DefaultProduct"
